...
if "__main__" == __name__:
    ...
    # 创建模型
    model = AutoModelForCausalLM.from_pretrained("/root/autodl-tmp/THUCoAI/CharacterGLM-6B",torch_dtype=torch.half, trust_remote_code=True, low_cpu_mem_usage=True)
